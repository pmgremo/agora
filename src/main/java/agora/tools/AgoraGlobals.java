...
/**
   ...
   Amongst others, this includes the globally available root agora.objects,
   which are filled with native agora.patterns by the routines in this class.
...
public class AgoraGlobals implements Serializable
{
  ...
  */
  ...
  /**
     ...
     both agora.objects (the Java version and the Agora version) are stored here,
  ...
  */
  ...
  /**
     ...
     global variables, and fills the root agora.objects with the standarly
     available methods.
     ...
     @exception agora.errors.AgoraError When something goes wrong during initialisation of the root
  ...
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError Whenever something goes wrong during installation of the
