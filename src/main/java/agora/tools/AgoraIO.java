...
/**
   This class is an abstract layer for all Agora IO that occurs duing the execution
...
*/
public class AgoraIO implements Serializable
{
  /**
  ...
  */
  public static void init(String i,TextArea o)
    {
      theInput = i;
      theOutput = o;
      count = 0;
