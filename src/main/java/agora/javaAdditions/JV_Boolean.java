...
public class JV_Boolean extends Object  implements Serializable
{
  /**
    ...
    @exception agora.errors.AgoraError When something goes wrong, e.g. when a method
  ...
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError Is never thrown in this particular case.
  */
