...
public class JV_Integer extends Object implements Serializable
{
  /**
     ...
     @return A generator containing Agora agora.patterns that are linked to the operator
     procedures defined in this class.
     @exception agora.errors.AgoraError Is thrown when something goes wrong while building the
