...
public class JV_Float extends Object  implements Serializable
{
  /**
     ...
     @return An ad hoc generator containing agora.patterns linked to the procedures
     of this class.
     @exception agora.errors.AgoraError When something goes wrong while building the generator
  ...
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError Is thrown when the argument is of wrong type.
  */
  ...
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError Is never thrown in this case.
  */
