...
/**
   ...
   by agora.objects with methods defined on them. This is so because the evaluator
...
public class Category implements Serializable
{
  ...
  /**
    ...
    */
  static public final boolean contains(int query,int bits)
  {
  ...
  /**
    ...
    */
  static public final boolean containsLessThan(int query,int bits)
  {
    return ((~query)|bits)==(~0);
  }
  ...
  /**
    ...
    */
  static public final String toString(int cat)
  {
    return "";
  }	
}
