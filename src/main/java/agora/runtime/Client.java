...
/**
  Client agora.objects are used for message passing to transport the actual arguments from the
...
public class Client extends Object implements Serializable
{
  ...
  /**
    This constructor should never be used except from within context agora.objects. The arguments
    of this constructor will be provided by the 'client-creator' in the Context class.
    @param actuals An array of expression agora.objects that can later be evaluated or upped
    by the client
  ...
  /**
    ...
    @exception agora.errors.AgoraError This exception is thrown when something goes wrong during
  ...
  /**
    ...
    @exception agora.errors.AgoraError When something goes wrong during the evaluation of the
    actual arguments.
    */
  ...
  /**
    ...
    @return An Array of Java (downed!) agora.objects.
    @exception agora.errors.AgoraError Is thrown when something goes wron during the downing
    of agora.objects.
    */
