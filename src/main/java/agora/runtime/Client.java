 ...
 * need a new client, you should ask the context, and each time you need a new context,
 * you should ask the client. This is possible since running an Agora program is a recursive
 ...
 * is then transparently copied through the evaluator.
 *
...
public class Client implements Serializable {
     ...
     * @throws agora.errors.AgoraError Is thrown when something goes wron during the downing
     *                                 of agora.objects.
     */
