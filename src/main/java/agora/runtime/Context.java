...
public class Context implements Serializable {
     ...
     * of primitive objects (java objects), this message is not implemented in the API's, and
     ...
     * and inspect it. This way *all* objects can be inspected.
     *
     * @throws agora.errors.AgoraError Is thrown when something goes wrong during inspection.
