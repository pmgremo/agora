...
/**
   ...
   agora.attributes. Several kinds of attributes exist, such as methods, mixin methods,...
...
public interface Attribute extends Serializable, Copyable
{
  /**
     ...
     will evaluate their body, doing variable read attributes will read their variable,
