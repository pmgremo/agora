...
*/
public class PrimGenerator extends MethodsGenerator implements Serializable
{
  /** 
  ...
  */
  public PrimGenerator (String nameOfFrame,Hashtable table,AbstractGenerator parent)
    {
  ...
  /** 
     ...
     specified pattern.
     @exception agora.errors.AgoraError When the message is not understood or when an error occurs
  ...
  */
  public AgoraObject delegate(AbstractPattern msg,Client client,Context context) throws AgoraError
	...
	return (((Attribute)lookupResult).doAttributeValue(msg,client,context.setParent(this.parent)));
      else
  ...
  /**
     ...
     @exception agora.errors.AgoraError If an error occurs during inspection, this exception is
  ...
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError Is always thrown as there is no private part to be set.
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError For some generators, it is impossible to add a layer around
