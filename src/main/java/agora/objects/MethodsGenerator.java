...
{
  /**
    Each methodsGenerator has a hashtable that links agora.patterns to agora.attributes.
    */
  ...
  */
  ...
  /**
    ...
    @exception agora.errors.AgoraError MethodsGenerator's that don't feature a private part will
