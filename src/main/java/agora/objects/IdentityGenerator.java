...
*/
abstract public class IdentityGenerator extends AbstractGenerator implements Serializable
{
  ...
  /**
     ...
     @param theContent The downed version of the object of which this generator is the identiy.
