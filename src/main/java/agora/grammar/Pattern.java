 ...
 */
abstract public class Pattern extends Expression {
    /**
     ...
     * @throws agora.errors.AgoraError Is thrown when there are wrong formals
     ...
     * @throws agora.errors.AgoraError When something goes wrong. For example, if we evaluate the
