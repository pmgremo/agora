...
abstract public class Expression implements Serializable
{
  ...
  /**
    ...
    @exception agora.errors.AgoraError Errors occured during evaluation.
    */
  ...
  /**
    ...
    @exception agora.errors.AgoraError Errors occuring during evaluation.
    */
  ...
  /**
    Besides the standard mapping of Java methods onto Agora agora.patterns, expressions also have
    a special suite of Agora agora.patterns that can be sent to them. This includes all the reifiers
    which have no associated Java syntax.
    @return A Primitive Generator containing the Agora agora.patterns and primitive agora.attributes.
    @exception agora.errors.AgoraError Happens when a method does not exist.
    */
  public static PrimGenerator generatorExpression() throws AgoraError
  {
	  var table = new Hashtable(40);
	  var result = new PrimGenerator("Expression",table,null);
    try
      {
		  var argtypes1 = new Class[1];
		  var argtypes2 = new Class[2];
		  var argtypes3 = new Class[3];
		  var argtypes4 = new Class[4];
		  var argtypes5 = new Class[5];
	argtypes1[0] = Class.forName("agora.runtime.Context");
	argtypes2[0] = Class.forName("agora.runtime.Context");
	argtypes2[1] = Class.forName("agora.grammar.Expression");
	argtypes3[0] = Class.forName("agora.runtime.Context");
	argtypes3[1] = Class.forName("agora.grammar.Expression");
	argtypes3[2] = Class.forName("agora.grammar.Expression");
	argtypes4[0] = Class.forName("agora.runtime.Context");
	argtypes4[1] = Class.forName("agora.grammar.Expression");
	argtypes4[2] = Class.forName("agora.grammar.Expression");
	argtypes4[3] = Class.forName("agora.grammar.Expression");
	argtypes5[0] = Class.forName("agora.runtime.Context");
	argtypes5[1] = Class.forName("agora.grammar.Expression");
	argtypes5[2] = Class.forName("agora.grammar.Expression");
	argtypes5[3] = Class.forName("agora.grammar.Expression");
	argtypes5[4] = Class.forName("agora.grammar.Expression");
	Class thisOne = Class.forName("agora.grammar.Expression");
  ...
  /**
    ...
    @exception agora.errors.AgoraError Happens when illegal agora.patterns are given.
    */
  public AgoraObject variable(Context context) throws AgoraError
	...
	theCat=theCat | Category.publik;
      // Install variable and initial value in the appropriate object part(s)
		var theVarCont = new VariableContainer(Up.glob.up(new Integer(0)));
  ...
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError When something goes wrong during installing the method.
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError When something goes wrong during installing the mixin.
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError When something goes wrong when installing the new view.
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError When something goes wrong during installation of the new method.
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError Perhaps a wrong pattern was there.
  */
  ...
  /** 
      ...
      @exception agora.errors.AgoraError Perhaps a wrong pattern is the receiver.
  */
  ...
  public AgoraObject fortodo(Context context,
	...
	throw (new ReifierMisused("FOR:TO:DO: can only be sent to unary agora.patterns"));
      ...
      newPriv.setPrivate(newPriv);
		var theVarCont = new VariableContainer(Up.glob.up(new Integer(init)));
		var varGetAtt  = new VarGetAttribute(theVarCont);
  ...
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError When something went wrong during the evaluation cycle.
  */
  ...
  */
  ...
  /**
     ...
     @return The Agora value of this expression.
     @exception agora.errors.AgoraError When something goes wrong, or when the exception does not match.
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError When something goes wrong (e.g. when the class doesn't exist).
  */
  ...
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError When something goes wrong when evaluating the receiving expression.
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError When something goes wrong (e.g. evaluation error or illegal
     object to down).
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError When the reifier cannot be installed or when wrong
  ...
  */
  ...
  /**
     ...
     @exception agora.errors.AgoraError Is thrown when the receiver does not evaluate to an integer.
  */
  ...
  /**
     See evalAsInteger
     @exception agora.errors.AgoraError When the receiver can not be evaluated to a boolean.
  */
  ...
  /**
     See evalAsInteger
     @exception agora.errors.AgoraError When the receiver can not be evaluated to a string.
  */
