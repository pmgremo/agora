...
*/
public class AgoraHalt extends AgoraError implements Serializable
{
  /**
  ...
  */
  ...
  /**
     To signal the message to which HALT was sent.
     No inspecting of any receiver is possible.
  */
  public void signal()
    {
      this.setUpDialog("Program HALT Encountered.\n\n",null);
    }
}
