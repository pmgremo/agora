...
/**
  A UserUnaryPattern is an Agora expression denoting ordinary unary patterns.
  Examples are 'abs' or other identifiers.
  @author Wolfgang De Meuter (Programming Technology Lab).
	Last change:  E    16 Nov 97    1:42 am
*/
public class UserUnaryPattern extends UserPattern implements Serializable
{
  ...
  /**
    ...
    @exception errors.AgoraError When something goes wrong (will never happen in this
