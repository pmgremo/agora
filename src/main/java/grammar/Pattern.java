...
abstract public class Pattern extends Expression implements Serializable
{
  ...
  /**
    ...
    @exception errors.AgoraError Is thrown when there are wrong formals
  ...
  @exception errors.AgoraError When something goes wrong. For example, if we evaluate the
