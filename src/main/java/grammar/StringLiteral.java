...
public class StringLiteral extends Literal implements Serializable
{
  ...
  /**
    ...
    @return A Generator containing the patterns (and associated attributes) that can
    be sent to string literals.
    @exception errors.AgoraError When something goes wrong during the creation of the
  ...
  public static PrimGenerator generatorStringLiteral() throws AgoraError
  {
	...
	Class thisOne = Class.forName("grammar.StringLiteral");
  ...
  /**
     ...
     @exception errors.AgoraError The exception that will terminate the program.
  */
