...
/**
   ...
   for unary, operator and keyword patterns.
...
{ 
  ...
  /**
     ...
     @return A generator containing the patterns and associated attributes
     that a user pattern understands, from within Agora.
     @exception errors.AgoraError When something goes wrong, e.g. when a method has been deleted from this
     class.
  */
  public static PrimGenerator generatorUserPattern() throws AgoraError
      ...
      try
	{
	  ...
	  Class thisOne = Class.forName("grammar.UserPattern");
  ...
  /**
    ...
    @exception errors.AgoraError The exception raised.
    */
  ...
  */
  ...
  /**
    ...
    @exception errors.AgoraError When something went wrong (e.g. pattern is not in the super)
    */
