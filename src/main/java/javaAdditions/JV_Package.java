...
/**
   This is the implementation level class representing 'package' objects in Agora.
   ...
   class is returned such that an Agora programmer can start making objects
   of that class.
...
public class JV_Package extends Object implements Serializable
{
  ...
  */
  ...
  /**
     ...
     @return A generator containing patterns linked to the procedures in this class.
  */
  public static PrimGenerator generatorJV_Package()
      ...
      try
	{
	  ...
	  thisOne = Class.forName("javaAdditions.JV_Package");
	}
